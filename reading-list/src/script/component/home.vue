      ...
      <div class="carousel-item-wrapper">
        ...
        <div class="carousel-item" v-for="issue of latestIssues">
          <div class="carousel-content">
            <router-link
              :to="{ name: 'week', params: { category: issue.categoryEncoded, date: issue.date } }"
            >
...
export default {
  ...
  methods: {
    ...
    slide(direction) {
      ...
      let carouselItems = document.getElementsByClassName(
        "carousel-item"
      ) as HTMLCollectionOf<HTMLElement>;
      for (var i = 0; i < carouselItems.length; i++) {
        carouselItems[i].style.transform = `translateX(${this.carouselIndex *
          -100}%)`;
      }
    }
  }
